...
txt2int = {"one": 1, "two": 2, "three": 3, "four": 4, "five": 5, "six": 6, "seven": 7, "eight": 8, "nine": 9}
acc_pt1 = acc_pt2 = 0
...
for row in sys.stdin:
    ...
    first = digits_pt2[0] if digits_pt2[0].isdigit() else txt2int[digits_pt2[0]]
    last = digits_pt2[-1] if digits_pt2[-1].isdigit() else txt2int[digits_pt2[-1]]
